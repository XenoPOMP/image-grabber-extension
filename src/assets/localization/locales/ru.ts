...
export const ru: I18Locales = {
  ...
  noResults: {
    message: 'Кажется, мы ничего не нашли',
    description:
      'Эта надпись появляется тогда, когда на странице не было найдено ни одной фотографии.'
  },

  galleryAdWarnHeading: {
    message: 'Реклама',
    description: 'Предупреждение о том, что данная картинка является рекламной.'
  }
};
